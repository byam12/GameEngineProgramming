...
public class EquipmentButtonManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        invenButtons = inventoryButtonManager.GetInventoryButtons();
    }
                ...
                case 0:
                    ...
                    for (int i = 0; i < invenButtons.Length; i++)
                    {
                        if (i < amuletInventory1.amulets1.Count)
                        {
                            ...
                            if (invenButtons[i].GetComponent<Outline>().IsActive())
                            {
                                inventoryButtonManager.OnButtonClicked(i);
                            }
                        }
                        else
                        {
